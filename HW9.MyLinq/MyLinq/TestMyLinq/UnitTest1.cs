...
public class Tests
{
    ...
    public void GetPrimes_FirstEightPrimes_AreCorrect()
    {
        ...
        var primes = MyLinq.GetPrimes().TakeFirst(8);
    ...
    public void TakeFirst_ReturnsCorrectNumberOfElements()
    {
        ...
        var result = source.TakeFirst(2).ToList();

        Assert.Equals(new[] { 1, 2 }, result);
    }
    ...
    {
        var source = new[] { 1, 2 };
        var result = source.TakeFirst(5).ToList();
    ...
    {
        var source = new[] { 1, 2, 3, 4, 5 };
        var result = source.MySkip(2).ToList();

        Assert.Equals(new[] { 3, 4, 5 }, result);
    }
    ...
    public void MySkip_WhenSkipZero_ReturnsFullSequence()
    {
        ...
        var result = source.MySkip(0).ToList();
    ...
    {
        var prime = MyLinq.GetPrimes().Skip(100).TakeFirst(1).Single();
        Assert.Equals(MyLinq.IsPrime(prime), true);
    }
}
